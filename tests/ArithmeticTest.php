...
class ArithmeticTest extends TestCase
{
    ...
    {
        expect(Money::fromString('234.19')->negate()->asInteger())->equals(-23419);
        expect(Money::fromString('-200')->negate()->asInteger())->equals(20000);
    ...
    public function testSumKopecks()
    {
        ...
        expect($t2->asInteger())->equals(20);
        
        $t2 = (new Money(99))->add(new Money(1));
        expect($t2->asFloat())->equals(1);
        expect($t2->asInteger())->equals(100);
    }
    ...
    public function testSumRubles()
    {
        ...
        expect($t2->asInteger())->equals(300);
    }
    ...
    public function testSumMixed()
    {
        ...
        expect($t2->asInteger())->equals(400);
    }
    ...
    public function testSubtractRubles()
    {
        ...
        expect($t2->asInteger())->equals(200);
    ...
    public function testAllocateToTargets()
    {
        ...
        expect($byHalf[0]->asInteger())->equals(6000);
        ...
        expect($byThree[0]->asInteger())->equals(4000);
        ...
        expect($byThree[0]->asInteger())->equals(3334);
        expect($byThree[1]->asInteger())->equals(3333);
    
        $money = new Money(4);
        $byThree = $money->allocateToTargets(3);
        expect($byThree)->count(3);
        expect($byThree[0]->asInteger())->equals(2);
        expect($byThree[1]->asInteger())->equals(1);
        expect($byThree[2]->asInteger())->equals(1);
    
        $money = new Money(2);
        $byThree = $money->allocateToTargets(3);
        expect($byThree)->count(3);
        expect($byThree[0]->asInteger())->equals(1);
        expect($byThree[1]->asInteger())->equals(1);
        expect($byThree[2]->asInteger())->equals(0);
    
        //!!!Warning
        $money = new Money(0);
        $byThree = $money->allocateToTargets(3);
        expect($byThree)->count(3);
        expect($byThree[0]->asInteger())->equals(0);
        expect($byThree[1]->asInteger())->equals(0);
        expect($byThree[2]->asInteger())->equals(0);
    }
    ...
    public function testAllocateByRatio()
    {
        ...
        expect($division[0]->asInteger())->equals(2400);
        expect($division[1]->asInteger())->equals(9600);
        
        $division = $money->allocateByRatios([50, 50]);
        expect($division[0]->asInteger())->equals(6000);
        expect($division[1]->asInteger())->equals(6000);
        
        $division = $money->allocateByRatios([30, 40, 30]);
        expect($division[0]->asInteger())->equals(3600);
        expect($division[1]->asInteger())->equals(4800);
        expect($division[2]->asInteger())->equals(3600);
        
        $division = $money->allocateByRatios([1, 1, 1]);
        expect($division[0]->asInteger())->equals(4000);
        expect($division[1]->asInteger())->equals(4000);
        expect($division[2]->asInteger())->equals(4000);
    
        $division = $money->allocateByRatios([1,2,3,4,5]);
        expect($division[0]->asInteger())->equals(800);
        expect($division[1]->asInteger())->equals(1600);
        expect($division[2]->asInteger())->equals(2400);
        expect($division[3]->asInteger())->equals(3200);
        expect($division[4]->asInteger())->equals(4000);
    
        $money = new Money(12);
        $division = $money->allocateByRatios([1, 1, 1]);
        expect($division[0]->asInteger())->equals(4);
        expect($division[1]->asInteger())->equals(4);
        expect($division[2]->asInteger())->equals(4);
    
        $money = new Money(2);
        $division = $money->allocateByRatios([1, 1, 1]);
        expect($division[0]->asInteger())->equals(1);
        expect($division[1]->asInteger())->equals(1);
        expect($division[2]->asInteger())->equals(0);
    
        $money = new Money(1);
        $division = $money->allocateByRatios([1, 1, 1]);
        expect($division[0]->asInteger())->equals(1);
        expect($division[1]->asInteger())->equals(0);
        expect($division[2]->asInteger())->equals(0);
